MainApp.controller("LicenseController", ["$scope", "LicenseService", "LicenseTypeService", "$http", "NgTableParams", function ($scope, LicenseService, LicenseTypeService, $http, NgTableParams) {
