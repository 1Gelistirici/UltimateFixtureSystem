MainApp.controller("AccessoryController", ["$scope", "AccessoryService", "CategoryService", "AccessoryModelService", "$http", "NgTableParams", function ($scope, AccessoryService, CategoryService, AccessoryModelService, $http, NgTableParams) {
